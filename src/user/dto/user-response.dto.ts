export class UserResponseDto {
  constructor(user: any) {
    ...
    this.position = user.u_position;
    this.division = user.u_division;
    this.salary_gross = user.u_salary_gross;
    this.address_line1 = user.u_address_line1;
    this.address_line2 = user.u_address_line2 ?? null;
    this.city = user.u_city;
    this.province = user.u_province;
    this.postal_code = user.u_postal_code;
